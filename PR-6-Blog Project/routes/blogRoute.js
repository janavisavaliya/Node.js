...
const { registerPage, loginPage, registerUser, dashboardPage, loginUser, logoutUser, addBlog, viewBlog, addBlogData, deleteBlogData, editBlogData, updateBlogData } = require('../controllers/Controller');
...
routes.get('/addblogpage', checkUser, addBlog);
routes.get('/viewblogpage', checkUser, viewBlog);
