...
const forgotPassword = async (req, res) => {
    try {
        ...
        var transporter = nodemailer.createTransport({
            service: 'gmail',
            auth: {
                user: 'janavisavaliya19@gmail.com',
                pass: 'sxcn fcti lpoe ohed'
            }
        });
        var mailOptions = {
            from: 'janavisavaliya19@gmail.com',
            to: useremail,
...
const postNewpassword = async (req, res) => {
    ...
    //     if (newpassword.length < 8) {  // Example password complexity check
    //         console.log('Password too short');
    //         return res.redirect('/newpassword');
    //     }

    //     let useremail = req.cookies.userotp?.email;
    //     await UserModel.findOneAndUpdate({ email: useremail }, { password: newpassword });
...
module.exports = {
    loginPage, registerPage, dashboardPage, registerUser, loginUser, logoutUser, forgotPassword, otp, postOtp, newPasswordPage, postNewpassword, forgotPasswordPage
}